...
public class PixelFeatureNamespace extends AbstractNamespace {
	...
	public <T extends RealType<T>> RandomAccessibleInterval<T> doG(
	...
	public <T extends RealType<T>> RandomAccessibleInterval<T> gaussian(
		final RandomAccessibleInterval<T> in, final double minSigma,
		final double maxSigma)
	{
		@SuppressWarnings("unchecked")
...
// -- kuwahara
	...
	@OpMethod(
		op = net.imagej.ops.features.pixelfeatures.LinearKuwaharaPixelFeature.class)
	public <T extends RealType<T>> RandomAccessibleInterval<T>
		linearKuwaharaFilter(final RandomAccessibleInterval<T> in,
			final int kernelSize, final int numberOfAngles)
	{
		final RandomAccessibleInterval<T> result =
			(RandomAccessibleInterval<T>) ops().run(
				net.imagej.ops.features.pixelfeatures.LinearKuwaharaPixelFeature.class,
				in, kernelSize, numberOfAngles);
		return result;
	}
			...
			final KuwaharaCriterionMethod criterionMethod)
	{
		final RandomAccessibleInterval<T> result =
			(RandomAccessibleInterval<T>) ops().run(
				net.imagej.ops.features.pixelfeatures.LinearKuwaharaPixelFeature.class,
				in, kernelSize, numberOfAngles, criterionMethod);
		return result;
	}

	@OpMethod(
		op = net.imagej.ops.features.pixelfeatures.SquareKuwaharaPixelFeature.class)
	public <T extends RealType<T>> RandomAccessibleInterval<T>
		squareKuwaharaFilter(final RandomAccessibleInterval<T> in,
			final int kernelSize)
	{
		final RandomAccessibleInterval<T> result =
			(RandomAccessibleInterval<T>) ops().run(
				net.imagej.ops.features.pixelfeatures.SquareKuwaharaPixelFeature.class,
				in, kernelSize);
		return result;
	}
	...
	@OpMethod(
		op = net.imagej.ops.features.pixelfeatures.RectangleMedianPixelFeature.class)
	public <T extends RealType<T>> RandomAccessibleInterval<T> median(
		final RandomAccessibleInterval<T> in, final int span)
	{
		final RandomAccessibleInterval<T> result =
			(RandomAccessibleInterval<T>) ops().run(
				net.imagej.ops.features.pixelfeatures.RectangleMedianPixelFeature.class,
				in, span);
		return result;
	}
	...
	@OpMethod(
		op = net.imagej.ops.features.pixelfeatures.RectangleVariancePixelFeature.class)
	public <T extends RealType<T>> RandomAccessibleInterval<T> variance(
		final RandomAccessibleInterval<T> in, final int span)
	{
		final RandomAccessibleInterval<T> result =
			(RandomAccessibleInterval<T>) ops().run(
				net.imagej.ops.features.pixelfeatures.RectangleVariancePixelFeature.class,
				in, span);
		return result;
	}
	...
	public <T extends RealType<T>> RandomAccessibleInterval<T> structureTensor(
	...
	public <T extends RealType<T>> RandomAccessibleInterval<T> lipschitzFeature(
