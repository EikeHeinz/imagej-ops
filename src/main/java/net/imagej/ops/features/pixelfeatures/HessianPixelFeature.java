...
import net.imagej.ops.Ops.Pixelfeatures.HessianFeature;
...
@Plugin(type = Ops.Pixelfeatures.HessianFeature.class)
public class HessianPixelFeature<T extends RealType<T>> extends
		AbstractUnaryFunctionOp<RandomAccessibleInterval<T>, RandomAccessibleInterval<T>> implements HessianFeature {
