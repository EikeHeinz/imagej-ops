...
import net.imagej.ops.Ops.Pixelfeatures.LoGFeature;
...
@Plugin(type = Ops.Pixelfeatures.LoGFeature.class)
public class LoGPixelFeature<T extends RealType<T>> extends
		AbstractUnaryFunctionOp<RandomAccessibleInterval<T>, RandomAccessibleInterval<T>> implements LoGFeature {
